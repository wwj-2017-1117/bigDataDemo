...
/**
 * @Author yangyue
 * @Date Created in 下午5:40 2019/2/22
 * @Modified by:
 * @Description:
 **/
public class QuestionAnswerApp extends Configured implements Tool {
    /**
     * @param args
     * @return
     * @throws Exception
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(QuestionAnswerApp.class);
        ((JobConf) job.getConfiguration()).setJar(jarFile.toString());
        //Mapper输入
        job.setMapperClass(MultiInputDataApp.QuestionAnswerMapper.class);
        job.setInputFormatClass(TextInputFormat.class);
        TextInputFormat.setInputPaths(job, new Path(args[0]));
        //reduce 设置
        job.setReducerClass(MultiInputDataApp.QuestionAnswerReducer.class);
        //输出
    ...
    public static void main(String[] args) throws Exception {
        ...
        int exitCode = ToolRunner.run(new QuestionAnswerApp(), otherArgs);
        if (exitCode == 0) {
